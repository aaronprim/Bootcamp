...
<body id="body">
    ...
    <script>
        ...
        getValueFromId(id) = id => document.getElementById(id).value;
        ...
        document.getElementById("change-background").onclick = () => setBackgroundColorById("change-background", getValueFromId("color-input"));
    </script>
</body>
